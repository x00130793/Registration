...
insert into user (email,fname,lname,password,role) values ( 'admin@products.com', 'Alice', 'Aaaan', 'password', 'admin' );
insert into user (email,fname,lname,password,role) values ( 'manager@products.com', 'Bob', 'Madser', 'password', 'manager' );
insert into user (email,fname,lname,password,role) values ( 'customer@products.com', 'Charlie', 'ddddamer', 'password', 'customer' );
